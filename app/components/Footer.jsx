  ...
  return (
    <div className='flex h-auto w-full flex-col justify-center items-center bg-black'>
        ...
        <div className='absolute w-1/2 bg-brandBlue h-auto rounded-2xl'>
          ...
          <form action="mailto:chayan.adiq@gmail.com" method="post" enctype="text/plain" className='w-full justify-center text-center pb-10'>
            <input name="sname" type="email" className='px-10 py-5 text-lg rounded-lg mx-5' placeholder='e-main' />
            <input name='ssubject' type="text" className='px-10 py-5 text-lg rounded-lg mx-5' placeholder='your query' />
            <button className='px-10 py-5 text-lg rounded-lg mx-5 bg-black text-white'>Submit</button>
          </form>
        </div>
        <div className='h-[30rem] w-full bottom-[10px] flex flex-row justify-center items-center text-white'>
          <div className='flex flex-col justify-start items-start w-full'>
            ...
            <p className='px-10 tracking-wide leading-10'>Presenting Bangladeshi delicacy to the World</p>
            <p className='px-10 relative -bottom-40 tracking-wide align-text-bottom leading-10'>Sundarbans Mangrove Forest</p>
          </div>
