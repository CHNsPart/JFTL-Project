...
const ValueChain = () => {
  return (
    <div id="valueChain" className='flex h-screen w-full my-14 flex-col justify-center items-center'>
        ...
        <Image src={value} height="auto" width="auto" className='h-auto px-24 w-full my-10' />
    </div>
  )
}
