  ...
  return (
    ...
    <div className='flex flex-col lg:flex-row h-full w-full justify-center items-center'>
      <div className='flex w-full lg:w-1/2 flex-col justify-center items-center'>
        <Image height={"auto"} width={"auto"} className='h-44 lg:-mt-[5rem] opacity-10 lg:-ml-[15rem] w-auto absolute'
          src={b1} 
        />
        <Image height={"auto"} width={"auto"} className='h-24 lg:rotate-90 lg:mt-[2rem] opacity-10 lg:ml-[15rem] w-auto absolute'
          src={b1} 
        />
        ...
        <p className='w-full lg:w-1/2 text-center mt-5 tracking-wider'>There are 5 major players in the total value chain of Frozen Soft Shell Crab farming and JFTL plays three major roles among them. These are:
        </p>
      </div>
